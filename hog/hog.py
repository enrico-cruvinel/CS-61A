...
def is_swap(player_score, opponent_score):
    ...
    """
    opponent_unit = opponent_score%10
    opponent_score //=10 
    opponent_decimal = opponent_score%10
    player_unit = player_score%10
    player_score //= 10
    player_decimal = player_score%10
    return abs(player_decimal-player_unit) == abs(opponent_decimal-opponent_unit) 
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    num_rolls, k = 1, 1
    highest_average = average(k, dice)    
    average = make_averaged(roll_dice, num_samples)
    num_rolls = 1
    highest_average = average(num_rolls, dice)
    for i in range(2, 11):
        new_average = average(i, dice)
        if new_average > highest_average: 
            highest_average = new_average 
            num_rolls = i
    return num_rolls
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if opponent_score > new_score and is_swap(new_score, opponent_score):
        return 0
    elif opponent_score < new_score and is_swap(new_score, opponent_score):
        return num_rolls
