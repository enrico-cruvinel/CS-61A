...
(foo (+ 1 2) (* 3 4))
;expect Error: unkown identifier: foo
...
(+ y 2)
; expect Error: operand 0 (b) is not a number
...
(define a b)
;expect Error: unknown identifier: b
...
(if (< 2018 2017) (print 'foo) (print 'bar))
;expect bar

(cond ((< 1 2) (print 'hey))
      ((= 1 5) (print 'banana))
      (else (print 'howreyoudoing?))
